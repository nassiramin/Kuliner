      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            <img src="img/logo-doang.png" width="61" height="90" />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>Pencarian dan Rekomendasi Tempat Kuliner Berbasis LBS</h4>
        <p>Program ini dibuat oleh Nasir Amin sebagai Tugas Akhir Jurusan Teknik Informatika UPNVYK</p>
